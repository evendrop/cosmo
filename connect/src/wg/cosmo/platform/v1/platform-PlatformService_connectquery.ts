...
/**
 * ExportPersistedOperations exports all persisted operations for a federated graph
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.ExportPersistedOperations
 */
export const exportPersistedOperations = {
  localName: "exportPersistedOperations",
  name: "ExportPersistedOperations",
  kind: MethodKind.Unary,
  I: ExportPersistedOperationsRequest,
  O: ExportPersistedOperationsResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
